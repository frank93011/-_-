...
class snake_window:
    ...
    def gen_frame(self):
        ...
        self.canvas = Canvas(master = self.frame1, bg = 'brown', width = self.wid, height = self.hei - self.shei)
    ...
    def draw_game_over(self, bypass = False):
        ...
        self.canvas.create_text(wid_1_2, hei_5_6, text = 'hi', font = font_set4, tag = 'gameover_text')
