...
class snake_window:
    ...
    def createWidgets(self):
        f1 = tkFont.Font(size=40, family="Noto Sans CJK TC Bold")
        f2 = tkFont.Font(size=25, family="Comic Sans MS")
        self.image = ImageTk.PhotoImage(file = "D:\document\dead.jpg")
        ...
        self.canvas.create_image(380,305,image = self.image)
        self.frame1.pack()
        self.frame2.pack(side = LEFT)
        self.slabel.pack()
        self.canvas.pack()
        self.start_classic_button = tk.Button(self, text='Classic', height=1, width=8, command = self.start_classic_game, font=f2, fg='#007500', bg='#C2FF68')
        self.start_classic_button.place(x=130, y=520)
        self.start_advanced_button = tk.Button(self, text='Advanced', height=1, width=8, command = self.start_advanced_game, font=f2, fg='#BB3D00', bg='#FFAF60')
        self.start_advanced_button.place(x=430, y=520)
    ...
    def draw_walls(self):
     ...
     #   add64 = [(540,535),(612,535)]
        ...
        self.canvas.create_line(*add1, width = 10, fill = 'grey')
        self.canvas.create_line(*add2, width = 10, fill = 'grey')
        self.canvas.create_line(*add3, width = 10, fill = 'grey')
        self.canvas.create_line(*add4, width = 10, fill = 'grey')
        self.canvas.create_line(*add5, width = 10, fill = 'grey')
        self.canvas.create_line(*add6, width = 10, fill = 'grey')
        self.canvas.create_line(*add7, width = 10, fill = 'grey')
        self.canvas.create_line(*add8, width = 10, fill = 'grey')
        self.canvas.create_line(*add9, width = 10, fill = 'grey')
        self.canvas.create_line(*add10, width = 10, fill = 'grey')
        self.canvas.create_line(*add11, width = 10, fill = 'grey')
        self.canvas.create_line(*add12, width = 10, fill = 'grey')
        self.canvas.create_line(*add13, width = 10, fill = 'grey')
        self.canvas.create_line(*add14, width = 10, fill = 'grey')
        self.canvas.create_line(*add15, width = 10, fill = 'grey')
        self.canvas.create_line(*add16, width = 10, fill = 'grey')
        self.canvas.create_line(*add17, width = 10, fill = 'grey')
        self.canvas.create_line(*add18, width = 10, fill = 'grey')
        self.canvas.create_line(*add19, width = 10, fill = 'grey')
        self.canvas.create_line(*add20, width = 10, fill = 'grey')
        self.canvas.create_line(*add21, width = 10, fill = 'grey')
        self.canvas.create_line(*add22, width = 10, fill = 'grey')
        self.canvas.create_line(*add23, width = 10, fill = 'grey')
        self.canvas.create_line(*add24, width = 10, fill = 'grey')
        self.canvas.create_line(*add25, width = 10, fill = 'grey')
        self.canvas.create_line(*add26, width = 10, fill = 'grey')
        self.canvas.create_line(*add27, width = 10, fill = 'grey')
        self.canvas.create_line(*add28, width = 10, fill = 'grey')
        self.canvas.create_line(*add29, width = 10, fill = 'grey')
        self.canvas.create_line(*add30, width = 10, fill = 'grey')
        self.canvas.create_line(*add31, width = 10, fill = 'grey')
        self.canvas.create_line(*add32, width = 10, fill = 'grey')
        self.canvas.create_line(*add33, width = 10, fill = 'grey')
        self.canvas.create_line(*add34, width = 10, fill = 'grey')
        self.canvas.create_line(*add35, width = 10, fill = 'grey')
        self.canvas.create_line(*add36, width = 10, fill = 'grey')
        self.canvas.create_line(*add37, width = 10, fill = 'grey')
        self.canvas.create_line(*add38, width = 10, fill = 'grey')
        self.canvas.create_line(*add39, width = 10, fill = 'grey')
        self.canvas.create_line(*add40, width = 10, fill = 'grey')
        self.canvas.create_line(*add41, width = 10, fill = 'grey')
        self.canvas.create_line(*add42, width = 10, fill = 'grey')
        self.canvas.create_line(*add43, width = 10, fill = 'grey')
        self.canvas.create_line(*add44, width = 10, fill = 'grey')
        self.canvas.create_line(*add47, width = 10, fill = 'grey')
        self.canvas.create_line(*add48, width = 10, fill = 'grey')
        self.canvas.create_line(*add49, width = 10, fill = 'grey')
        self.canvas.create_line(*add50, width = 10, fill = 'grey')
        self.canvas.create_line(*add51, width = 10, fill = 'grey')
        self.canvas.create_line(*add52, width = 10, fill = 'grey')
        self.canvas.create_line(*add53, width = 10, fill = 'grey')
        self.canvas.create_line(*add54, width = 10, fill = 'grey')
        self.canvas.create_line(*add55, width = 10, fill = 'grey')
        self.canvas.create_line(*add56, width = 10, fill = 'grey')
        self.canvas.create_line(*add57, width = 10, fill = 'grey')
        self.canvas.create_line(*add58, width = 10, fill = 'grey')
        self.canvas.create_line(*add59, width = 10, fill = 'grey')
        self.canvas.create_line(*add60, width = 10, fill = 'grey')
        self.canvas.create_line(*add61, width = 10, fill = 'grey')
        self.canvas.create_line(*add62, width = 10, fill = 'grey')
        self.canvas.create_line(*add63, width = 10, fill = 'grey')
       # self.canvas.create_line(*add64, width = 10, fill = 'grey')
        self.canvas.create_line(*add65, width = 10, fill = 'grey')
        self.canvas.create_line(*add66, width = 10, fill = 'grey')
        self.canvas.create_line(*add67, width = 10, fill = 'grey')
        self.canvas.create_line(*add68, width = 10, fill = 'grey')
        self.canvas.create_line(*add69, width = 10, fill = 'grey')
        self.canvas.create_line(*add70, width = 10, fill = 'grey')
        self.canvas.create_line(*add71, width = 10, fill = 'grey')
        self.canvas.create_line(*add72, width = 10, fill = 'grey')
        self.canvas.create_line(*add73, width = 10, fill = 'grey')
        self.canvas.create_line(*add76, width = 10, fill = 'grey')
        self.canvas.create_line(*add77, width = 10, fill = 'grey')
        self.canvas.create_line(*add78, width = 10, fill = 'grey')
        self.canvas.create_line(*add79, width = 10, fill = 'grey')
        self.canvas.create_line(*add82, width = 10, fill = 'grey')
        self.canvas.create_line(*add83, width = 10, fill = 'grey')
        self.canvas.create_line(*add84, width = 10, fill = 'grey')
        self.canvas.create_line(*add85, width = 10, fill = 'grey')
        self.canvas.create_line(*add86, width = 10, fill = 'grey')
        self.canvas.create_line(*add87, width = 10, fill = 'grey')
        self.canvas.create_line(*add88, width = 10, fill = 'grey')
        self.canvas.create_line(*add89, width = 10, fill = 'grey')
        self.canvas.create_line(*add90, width = 10, fill = 'grey')
        self.canvas.create_line(*add91, width = 10, fill = 'grey')
        self.canvas.create_line(*add92, width = 10, fill = 'grey')
        self.canvas.create_line(*add93, width = 10, fill = 'grey')
        self.canvas.create_line(*add94, width = 10, fill = 'grey')
        self.canvas.create_line(*add95, width = 10, fill = 'grey')
        self.canvas.create_line(*add96, width = 10, fill = 'grey')
        self.canvas.create_line(*add97, width = 10, fill = 'grey')
        self.canvas.create_line(*add98, width = 10, fill = 'grey')
        self.canvas.create_line(*add99, width = 10, fill = 'grey')
        self.canvas.create_line(*add100, width = 10, fill = 'grey')
        self.canvas.create_line(*add101, width = 10, fill = 'grey')
        self.canvas.create_line(*add102, width = 10, fill = 'grey')
        self.canvas.create_line(*add103, width = 10, fill = 'grey')
        self.canvas.create_line(*add104, width = 10, fill = 'grey')
        self.canvas.create_line(*add105, width = 10, fill = 'grey')
        self.canvas.create_line(*add106, width = 10, fill = 'grey')
        self.canvas.create_line(*add107, width = 10, fill = 'grey')
        self.canvas.create_line(*add108, width = 10, fill = 'grey')
        self.canvas.create_line(*add109, width = 10, fill = 'grey')
        self.canvas.create_line(*add110, width = 10, fill = 'grey')
        self.canvas.create_line(*add111, width = 10, fill = 'grey')
        self.canvas.create_line(*add112, width = 10, fill = 'grey')
        self.canvas.create_line(*add113, width = 10, fill = 'grey')
        self.canvas.create_line(*add114, width = 10, fill = 'grey')
        self.canvas.create_line(*add115, width = 10, fill = 'grey')
        self.canvas.create_line(*add116, width = 10, fill = 'grey')
        self.canvas.create_line(*add117, width = 10, fill = 'grey')
        self.canvas.create_line(*add118, width = 10, fill = 'grey')
    ...
    def add_speed(self):
        ...
        self.timer_count -= int(self.timer_init * self.speed_step*3 / 10)
        return
    ...
    def re_init(self):
        self.image = ImageTk.PhotoImage(file = "D:\document\dead.jpg")
        self.canvas.create_image(380,310,image = self.image)
        self.score = 0
        self.draw_walls()
        self.slabel_dict = {'Score': self.score, 'Level': self.level, 'Speed': self.speed}
        self.now_dir = 'Down'
    ...
    def draw_mission_complete(self, bypass = False):
        ...
        self.image = ImageTk.PhotoImage(file = "D:\document\star.jpg")
        
        self.canvas.create_image(385,350,image = self.image)
        ...
        self.canvas.create_text(wid_1_2, hei_3_6, text = 'You are heading to level '+str(self.level), fill = 'white',font = font_set3, tag = 'missioncomplete_text')
        self.canvas.create_text(wid_1_2, hei_5_6, text = 'Press P to next level and press ESC to exit',fill = 'white', font = font_set3, tag = 'missioncomplete_text')
    ...
    def draw_game_over(self, bypass = False):
        ...
        self.image = ImageTk.PhotoImage(file = "D:\document\why.jpg")
        
        self.canvas.create_image(385,300,image = self.image)
...
class snake:
    def __init__(self, canvas_master, unit = 12, draw_body_origin = (0, 0), height = 24, width = 36, init_length = 3, color = 'white'):
