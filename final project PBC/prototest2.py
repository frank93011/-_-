...
class snake_window:
    ...
    def draw_mission_complete(self, bypass = False):
        ...
        self.canvas.create_text(wid_1_2, hei_3_6, text = 'Press SPACE to retry and press ESC to exit',fill = 'white', font = font_set3, tag = 'missioncomplete_text')
...
class starter(tkinter.Frame):
	...
	def createWidgets(self):
		...
		self.btnmode1 = tk.Button(self, text = "press to start", height = 2, width = 3, command = self.clickBtnmode1, font = f2)
		self.btnNum1.grid(row = 20, column = 6, sticky = tk.NE + tk.SW)
	def clickBtnmode1():
